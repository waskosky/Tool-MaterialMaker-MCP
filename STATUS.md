...
| Shared service, build/export and portable authoring contracts | ✅ verified | 641 passed, 1 Windows-only skip after upstream merge and sweep port; [contribution record](docs/upgrade/UPSTREAM.md). |
...
| Animated preview publication | ✅ verified | Complete verified frames, atomic GIF replacement and canonical inputs; `tests/test_preview_sweep.py`, `tests/upgrade/test_preview_sweep_policy.py`. |
